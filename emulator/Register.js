/***********************************************************************
* retro-lgp21/emulator Register.js
************************************************************************
...
class Register {
    ...
    set(value) {
        ...
        this.intVal = value % this.modVal;
        return value;
    }

    /**************************************/
    inc() {
        /* Increments the value of the register by one, wrapping around to zero
        if the register capacity overflows */
